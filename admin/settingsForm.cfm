...
<form method="post" action="#cgi.script_name#">
	...
	<fieldset>
		...
		<p>
			...
			<span class="hint">Displays the image file name as the title in the larger preview overlay. If using cfimage as the resize engine, it will display the IPTC description if one is present.</span>
			<span class="field">
