							   ...
							   <cfif isImageFile("#directory#/#name#")>
									...
									<cfif getSetting("MementoResizeEngine") eq "cfimage">
										...
										<cfif not fileExists("#directory#/thumbs/#name#")>
											...
											<cfset IPTCcaption=ImageGetIPTCTag(newThumbImage,"Caption/Abstract")>
											<cfset IPTCtitle=ImageGetIPTCTag(newThumbImage,"Object Name")>
								 ...
								 <cfif getSetting("MementoGalleryEffect") eq "shadowbox">
								 	<cfoutput><a href="#basePath#assets/content/memento/#albumName#/#name#"<cfif getSetting("MementoShowTitle") eq "yes"> title="<cfif isdefined("IPTCcaption")>#IPTCcaption#<cfelseif isdefined("IPTCtitle")>#IPTCtitle#<cfelse>#name#</cfif>"</cfif> class="#getSetting("MementoThumbClass")#" rel="shadowbox[group]"><img src="#basePath#assets/content/memento/#albumName#/thumbs/#name#" alt="#name#" /></a></cfoutput>
								 
								 <cfelseif getSetting("MementoGalleryEffect") eq "lightbox">
								 	<cfoutput><a href="#basePath#assets/content/memento/#albumName#/#name#"<cfif getSetting("MementoShowTitle") eq "yes"> title="<cfif isdefined("IPTCcaption")>#IPTCcaption#<cfelseif isdefined("IPTCtitle")>#IPTCtitle#<cfelse>#name#</cfif>"</cfif> class="#getSetting("MementoThumbClass")#" rel="lightbox[group]"><img src="#basePath#assets/content/memento/#albumName#/thumbs/#name#" alt="#name#" /></a></cfoutput>
								 
								 <cfelseif getSetting("MementoGalleryEffect") eq "fancybox">
								 	<cfoutput><a href="#basePath#assets/content/memento/#albumName#/#name#"<cfif getSetting("MementoShowTitle") eq "yes"> title="<cfif isdefined("IPTCcaption")>#IPTCcaption#<cfelseif isdefined("IPTCtitle")>#IPTCtitle#<cfelse>#name#</cfif>"</cfif> class="#getSetting("MementoThumbClass")#"><img src="#basePath#assets/content/memento/#albumName#/thumbs/#name#" alt="#name#" /></a></cfoutput>
